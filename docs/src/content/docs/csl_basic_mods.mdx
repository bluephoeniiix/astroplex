...
1. Your PC MUST have RAM larger than 16GB. (I propose you have 32GB RAM)
2. You need to restore Cities: Skylines to factory settings.
3. Purchase "Cities: Skylines - Industries" DLC.
...
1. Enables electricity transmission without power lines.
2. Enables electricity transmission along roads (a duplicated feature, enable it anyway).
3. Enables water, sewage, and heating transmission without pipes, and click its sub-option to ignore original water buildings.
4. Ignores area unlocking progression and permits building outside of own tiles.
